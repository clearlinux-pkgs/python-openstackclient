...
Version  : 1.0.4
Release  : 9
URL      : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-1.0.4.tar.gz
Source0  : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-1.0.4.tar.gz
...
Patch1: 0001-Added-support-to-osprofiler.patch
...
%prep
%setup -q -n python-openstackclient-1.0.4
%patch1 -p1
