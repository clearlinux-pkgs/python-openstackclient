...
Version  : 2.3.0
Release  : 24
URL      : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-2.3.0.tar.gz
Source0  : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-2.3.0.tar.gz
...
%prep
%setup -q -n python-openstackclient-2.3.0
%patch1 -p1
