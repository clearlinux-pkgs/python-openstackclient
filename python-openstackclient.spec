...
Version  : 1.9.0
Release  : 19
URL      : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-1.9.0.tar.gz
Source0  : http://tarballs.openstack.org/python-openstackclient/python-openstackclient-1.9.0.tar.gz
...
%prep
%setup -q -n python-openstackclient-1.9.0
%patch1 -p1
